...
This guide covers deploying your Fresh v2 application to Deno Deploy.

## Deno Deploy

Deno Deploy is the recommended deployment platform for Fresh applications. It provides:
- Automatic HTTPS
- Global edge network
...
- Detects Fresh projects
- Builds the application
- Serves from `main.ts`
- Handles static files from `static/`
- Serves islands correctly
